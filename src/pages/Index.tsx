...
const Index = () => {
  return (
    <div className="min-h-screen bg-calcuu-white font-inter">
        ...
        <div className="container mx-auto px-4 py-12 lg:py-20">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 items-center">
            ...
            <div className="lg:col-span-2 flex justify-center">
              <div className="relative h-[600px] w-[300px] overflow-hidden shadow-2xl">
                <img
                  ...
                  className="absolute -top-16 -left-16 -right-16 -bottom-16 w-[400px] h-[700px] object-cover"
                />
              </div>
            </div>
          </div>
      ...
      <section className="py-16 lg:py-24 bg-calcuu-background">
        <div className="container mx-auto px-4">
          <div className="max-w-[73rem] mx-auto flex flex-col justify-center items-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3.5 max-w-5xl mx-auto mb-3.5">
              {/* Feature Box 1 */}
              <div
              ...
              >
                ...
                <div className="relative z-10 flex flex-col items-center h-full">
                  ...
                  <p className="text-sm text-calcuu-text-sub leading-relaxed flex-1 flex items-center">
                    Geen zorgen meer over verkeerde inschatten. Calcuu berekent
                    automatisch alle materialen en uren.
                  </p>
                </div>
              </div>
              ...
              >
                ...
                <div className="relative z-10 flex flex-col items-center h-full">
                  ...
                  <p className="text-sm text-calcuu-text-sub leading-relaxed flex-1 flex items-center">
                    Verstuur direct professionele offertes naar je klanten met
                    je eigen bedrijfsgegevens en logo.
                  </p>
                </div>
              </div>
              ...
              >
                ...
                <div className="relative z-10 flex flex-col items-center h-full">
                  ...
                  <p className="text-sm text-calcuu-text-sub leading-relaxed flex-1 flex items-center">
                    Stop met het maken van offertes in de avonduren. Doe alles
                    direct op locatie in enkele minuten.
                  </p>
                </div>
              </div>
            </div>
      ...
      {/* Special Offer Text */}
      <div className="py-6" style={{ marginTop: "-2px" }}>
        <div className="container mx-auto px-4">
